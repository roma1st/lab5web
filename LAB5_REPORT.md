...
## Висновки
У роботі реалізовано повний CI/CD цикл: автоматизовані перевірки якості коду (lint + unit tests), контейнеризація застосунку через оптимізований multi-stage Dockerfile та публікація артефакту в GHCR. Підхід зменшує ризики людських помилок, забезпечує повторюваність збірок і створює фундамент для подальшого розширення до повного CD/GitOps.PR trigger 2026-03-30
